...
import {
    Table, Tag, Button, Row, Col, Space, message, Spin,
    Image, Popconfirm, Modal, Form, Upload
} from 'antd';
import {
    DeleteOutlined, EditOutlined, FileExcelOutlined,
...
const useExpandable = () => {
    ...
    return { expandedRowKeys, setExpandedRowKeys, expandedData, loadingExpandedRow, loadProducts, setModelId, modelId };
};
